...
class _QuizAppState extends State<QuizApp> {
  final List<Question> questions = [
    Question(
      'Loathe : Coersion',
      ['Detest : Caressing', 'Irritate : Caressing', 'Irate : Antagonism', 'Reluctant : Persuasion'],
      'Irate : Antagonism',
    ),
    Question(
      'Water : Swim',
      ['Graze : Grass', 'Plan : Implement', 'Flood : Damage', 'Ground : Play'],
      'Flood : Damage',
    ),
    Question(
      'Elevated : Exalted',
      ['Promoted : Excellence', 'Raise : Commensurate', 'Disorderly : Unfaithful', 'Dirty : Filthy'],
      'Raise : Commensurate',
    ),
    Question(
      'Primeval : Medieval',
      ['Dinosaur : Dragon', 'Gorilla : Soldier', 'Evolution : Revelation', 'Thorn : Rose'],
      'Evolution : Revelation',
    ),
    Question(
      'Pedant : Erudition',
      ['Prude : Modesty', 'Blunt : Politician', 'Diplomats : Tactless', 'Enemy : Friendly'],
      'Diplomats : Tactless',
    ),
    Question(
      'Capricious : Reliability',
      ['Extemporaneous : Predictability', 'Unreliable : Inhuman', 'Tenacious : Practicality', 'Arbitrary : Whimsical'],
      'Arbitrary : Whimsical',
    ),
    Question(
      'Summer : Raining',
      ['Monday : Sunday', 'Summer : Winter', 'December : January', 'Licence : Driving'],
      'Summer : Winter',
    ),
    Question(
      'Publicity : Sale',
      ['Convassing : Votes', 'Wound : Blood', 'Traffic : Accident', 'Money : Wages'],
      'Convassing : Votes',
    ),
    Question(
      'Colour : Eyes',
      ['Vision : Spectacles', 'Print : Newspaper', 'Medicine : Ailment', 'Fragrance : Nose'],
      'Vision : Spectacles',
    ),
    Question(
      'Straws : Nest',
      ['Water : Stream', 'Animals : Zoo', 'Threads : Cloth', 'Wood : Paper'],
      'Threads : Cloth',
    )
  ];
